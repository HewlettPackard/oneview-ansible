...
class DeploymentGroupFactsSpec(unittest.TestCase, ModuleContructorTestCase):
    """
    ...
    def setUp(self):
        ...
        self.TASK_GET_BY_NAME = self.DEPLOYMENT_GROUP_FACTS_EXAMPLES[2]['image_streamer_deployment_group_facts']
