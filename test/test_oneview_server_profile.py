...
class TestServerProfileModule(OneViewBaseTest):
    ...
    def test_get_available_servers_with_scopeuri(self):
        param_for_present = deepcopy(PARAMS_FOR_PRESENT)
        param_for_present['data']['scopeUris'] = '/rest/scopes/12ab33bb-391f-491a-adfb-02b0dc625b3e%20OR%20\
                /rest/scopes/3006eb67-a58f-4f5c-b173-e46309b2b87d'
