...
description:
    - Provides an interface to manage Logical Switch resources. Can create, delete, or refresh.
requirements:
    - "python >= 2.7.9"
    - "hpOneView"
...
options:
    ...
    data:
      description:
        - List with the Logical Switches properties.
      required: true
notes:
...
logical_switch:
    ...
    returned: On the states 'present' and 'refreshed'. Can be null.
    type: complex
'''
...
class LogicalSwitchModule(object):
    ...
    def __refresh(self, data):
        ...
        if resource:
            ...
            self.module.exit_json(changed=False, msg=LOGICAL_SWITCH_NOT_FOUND)
