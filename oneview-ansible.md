...
- If you define the volumeUri as null in the volumeAttachments list, it will be understood that the volume does not exists, so it will be created along with the server profile
...
>>>>>>> 4a48369... Fixed documentation for Interconnects
